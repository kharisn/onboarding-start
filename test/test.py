...
async def test_pwm_freq(dut):
    ...
    # Wait for rising edge manually (bit 0 of uo_out goes from 0 to 1)
    while (int(dut.uo_out.value) & 0x01) == 1:
        await ClockCycles(dut.clk, 1)
...
async def test_pwm_duty(dut):
    ...
    # Test 1: 0% duty cycle - should stay LOW
    ...
    # Test 2: 100% duty cycle - should stay HIGH
    ...
    # Test 3: 50% duty cycle - measure timing
